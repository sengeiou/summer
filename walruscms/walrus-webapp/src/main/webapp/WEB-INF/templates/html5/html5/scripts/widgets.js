lib.widget({
    ...
    construct: function construct() {
        var stepHeight = parseInt(lib.dom.getStyle(document.body, "line-height")),
            marginTop = parseInt(lib.dom.getStyle(this.element, "margin-top")),
            marginBottom = parseInt(lib.dom.getStyle(this.element, "margin-bottom")),
