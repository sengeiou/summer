<template>
  <div id="login">
    <div class='login-wrap'>
      <div class="img-wrap">
        <img src="@/assets/images/login.png" fit="contain" />
      </div>
      <div class="form-wrap">
        <!-- <el-form
                 ref="form"
    ...
    <!-- <password-dialog
                     ref="passwordDialog"
                     @handleSubmit="handleSubmit"></password-dialog> -->
  </div>
</template>
...
export default {
  ...
  //       },
  //       rules: {
  //         identity: [this.$rules.required()],
  //         desStr: [this.$rules.required()],
  //         captcha: [this.$rules.required()]
  //       }
  //     };
  //   },
  //   methods: {
  ...
  //           if (loginUrl) {
  //             window.location.href = `${loginUrl}?id=${escape(
  //               appId
  //             )}&sec=${escape(appSecret)}&type=1&&origin=${escape(
